  ...
  return <div className={styles.experience}>
    ...
    <main id="conteudo">
      ...
      <section className={styles.section} id="modalidades"><div className={styles.container}>
        ...
        <div className={styles.modeGrid}><article className={styles.raceFeatured}><span className={styles.eyebrow}>Modalidade competitiva</span><h3>Gravel Race</h3><p>Dispute as etapas e some pontos na classificação geral.</p><ul className={styles.raceFacts}><li>Ultimate: 4 etapas · troféus do 1º ao 5º</li><li>Short: 2 etapas · troféus do 1º ao 3º</li></ul><strong>Gravel e Cyclocross</strong><small>Sem assistência elétrica · premiação por categoria</small><a href="/inscricoes?modalidade=race#jornadas" className={styles.primary}>Quero competir ↗</a></article><article><span className={styles.eyebrow}>Para viver a travessia</span><h3>Legends Experience</h3><p>Desafio pessoal, sem ranking ou premiação competitiva.</p><strong>Gravel, MTB e E-bike</strong><small>E-bikes de pedal assistido, conforme regulamento</small><a href="/inscricoes?modalidade=experience#jornadas" className={styles.primary}>Quero a experiência ↗</a></article></div>
