...
const timeline = [
  ...
  ["◎", "Durante", "2 checkpoints com hidratação"],
  ...
  return (
    <main className="redesign">
      <style>{`
        ...
        .engineHome{padding:112px 0;background:#080a09;color:#f1ece3;border-top:1px solid var(--line);border-bottom:1px solid var(--line)}
        .engineHomeHead{display:grid;grid-template-columns:1.15fr .85fr;gap:70px;align-items:end;margin-bottom:48px}.engineHomeHead p:last-child{color:#a3a89f;font-size:17px;line-height:1.7;margin:0}.engineHome h2{font-size:clamp(48px,5vw,78px)}
        .engineFlow{display:grid;grid-template-columns:repeat(5,1fr);margin-bottom:28px;border:1px solid var(--line)}.engineFlow span{position:relative;padding:19px 15px;text-align:center;color:#d7d1c8;font:700 14px 'Barlow Condensed';letter-spacing:.09em;text-transform:uppercase;border-right:1px solid var(--line)}.engineFlow span:last-child{border:0}.engineFlow span:not(:last-child):after{content:'›';position:absolute;right:-7px;z-index:2;color:var(--copper);background:#080a09;padding:0 2px;font-size:23px;line-height:16px}
        .engineCards{display:grid;grid-template-columns:repeat(3,1fr);border-top:1px solid var(--line);border-left:1px solid var(--line)}.engineCard{min-height:190px;padding:27px;border-right:1px solid var(--line);border-bottom:1px solid var(--line)}.engineIcon{display:grid;place-items:center;width:35px;height:35px;border:1px solid var(--copper);color:var(--copper);font-size:18px}.engineCard h3{margin:25px 0 9px;font:700 25px 'Barlow Condensed';text-transform:uppercase}.engineCard p{margin:0;color:#969c93;font-size:14px;line-height:1.6}.engineHomeBottom{display:grid;grid-template-columns:1fr auto;gap:28px;align-items:center;margin-top:32px}.engineModes{display:flex;gap:25px;flex-wrap:wrap;color:#b9beb6;font-size:14px}.engineModes strong{color:#f1ece3}.engineLink{display:inline-flex;align-items:center;gap:35px;padding:18px 23px;background:var(--copper);color:#fff;font:700 15px 'Barlow Condensed';letter-spacing:.08em;text-transform:uppercase}
        ...
        .daySection{background:#0b0d0c;color:#f1ece3;padding:90px 0}.daySection .sectionHead{margin-bottom:38px}.timeline{border-top:1px solid var(--line)}.timelineItem{display:grid;grid-template-columns:38px 120px 1fr;gap:22px;align-items:center;padding:15px 0;border-bottom:1px solid var(--line)}.timelineIcon{display:grid;place-items:center;width:32px;height:32px;border:1px solid var(--line);color:var(--copper);font-size:16px}.timelineItem strong{color:var(--copper);font:700 23px 'Barlow Condensed'}.timelineItem span:last-child{font-size:16px;color:#c2c7bf}
        ...
        .kitEditorial{margin-top:72px;padding-top:54px;border-top:1px solid var(--line)}.kitEditorialHead{display:grid;grid-template-columns:.75fr 1fr 1.2fr;gap:36px;align-items:end;margin-bottom:28px}.kitEditorialHead .kicker{margin:0}.kitEditorialHead h3{margin:0;font:700 clamp(34px,3.2vw,52px)/.95 'Barlow Condensed';text-transform:uppercase}.kitEditorialHead>p:last-child{max-width:470px;margin:0;color:#9ca198;line-height:1.6}.kitDetailGrid{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:14px}.kitDetailCard{margin:0;overflow:hidden;border:1px solid var(--line);background:#171a17}.kitDetailMedia{height:clamp(280px,28vw,400px);display:flex;align-items:center;justify-content:center;padding:22px;background:radial-gradient(circle at 50% 48%,rgba(198,122,59,.12),transparent 62%),#111410}.kitDetailProduct{display:block;width:100%;height:100%;object-fit:contain;filter:drop-shadow(0 18px 24px rgba(0,0,0,.3))}.kitDetailCard figcaption{display:flex;justify-content:space-between;gap:18px;align-items:baseline;padding:18px 20px 20px;border-top:1px solid var(--line)}.kitDetailCard strong{color:#f1ece3;font:700 21px/1 'Barlow Condensed';letter-spacing:.04em;text-transform:uppercase}.kitDetailCard figcaption span{color:#8f958c;font-size:13px;text-align:right}
        ...
        @media(max-width:1000px){.redesign .wide{width:min(100% - 48px,920px)}.redesign .sectionHead,.destinationText,.profileBox,.engineHomeHead{grid-template-columns:1fr}.manifestoQuote{font-size:clamp(30px,5vw,46px)}.factsGrid,.safetyGrid,.stageGridNew{grid-template-columns:1fr 1fr}.modeGrid{grid-template-columns:1fr}.includedGrid,.kitDetailGrid{grid-template-columns:1fr 1fr}.kitEditorialHead{grid-template-columns:1fr 1.2fr}.kitEditorialHead .kicker{grid-column:1/-1}.engineCards{grid-template-columns:1fr 1fr}}
        @media(max-width:640px){.redesign .wide{width:calc(100% - 32px)}.heroRedesign{grid-template-rows:82px 1fr auto;min-height:100svh;background-position:68% center}.heroRedesign .navCta{display:inline-flex;padding:9px 11px;font-size:10px;letter-spacing:.06em}.heroMain{padding:44px 0}.heroCopy h1{font-size:56px}.heroIntro{font-size:16px}.heroStats{grid-template-columns:1fr 1fr}.heroStat:nth-child(2){border-right:0}.heroStat:nth-child(-n+2){border-bottom:1px solid var(--line)}.heroStat strong{font-size:38px}.manifestoRedesign,.factsBand,.modes,.daySection,.routePreview,.destinationStory,.includedSection,.safetySection,.profileSection,.faqSection,.engineHome{padding:68px 0}.manifestoQuote{font-size:30px;line-height:1.04}.manifestoButton{font-size:16px;padding:18px 20px;margin-top:30px}.manifestoHighlights{grid-template-columns:1fr 1fr;margin-top:48px}.manifestoHighlights span{border-bottom:1px solid rgba(17,17,17,.2);padding:18px 10px 18px 0}.manifestoHighlights span:not(:first-child){padding-left:10px}.factsGrid,.stageGridNew,.safetyGrid,.includedGrid,.cityStrip,.engineCards,.kitDetailGrid{grid-template-columns:1fr}.fact,.stageNew,.safetyCard,.cityStrip a{border-right:0;border-bottom:1px solid var(--line)}.modeCard{padding:34px 26px}.daySection{padding:64px 0}.daySection .sectionHead{margin-bottom:30px}.timelineItem{grid-template-columns:32px 76px 1fr;gap:12px;padding:13px 0}.timelineIcon{width:28px;height:28px;font-size:14px}.timelineItem strong{font-size:19px}.timelineItem span:last-child{font-size:14px}.stageNew{min-height:330px}.destinationText{gap:20px}.cityStrip a:last-child{padding-left:0}.includedGrid{background:transparent;border:0}.includedItem{border-bottom:1px solid var(--line)}.kitEditorial{margin-top:48px;padding-top:38px}.kitEditorialHead{grid-template-columns:1fr;gap:14px}.kitEditorialHead .kicker{grid-column:auto}.kitDetailMedia{height:300px;padding:18px}.profileBox{gap:34px}.engineHomeHead{gap:22px;margin-bottom:34px}.engineFlow{grid-template-columns:1fr}.engineFlow span{border-right:0;border-bottom:1px solid var(--line);padding:13px}.engineFlow span:last-child{border:0}.engineFlow span:not(:last-child):after{content:'⌄';right:auto;bottom:-8px;left:calc(50% - 7px)}.engineCard{min-height:0}.engineHomeBottom{grid-template-columns:1fr}.engineModes{display:grid;gap:10px}.engineLink{justify-content:space-between}}
      `}</style>
      ...
      <section className="engineHome" id="race-engine"><div className="wide"><div className="engineHomeHead"><div><p className="kicker">Tecnologia própria · Legends Race Engine</p><h2>Cada quilômetro conta.<br /><em>Cada resultado pode ser comprovado.</em></h2></div><p>Da atividade registrada no GPS à publicação oficial: percurso, passagens, decisões esportivas e resultados reunidos em uma única experiência.</p></div><div className="engineFlow" aria-label="Fluxo do Race Engine"><span>Pedale</span><span>Sincronize</span><span>Valide</span><span>Acompanhe</span><span>Comprove</span></div><div className="engineCards">{raceEngineFeatures.map(([icon,title,text])=><article className="engineCard" key={title}><span className="engineIcon" aria-hidden="true">{icon}</span><h3>{title}</h3><p>{text}</p></article>)}</div><div className="engineHomeBottom"><div className="engineModes"><span><strong>Gravel Race:</strong> tempo, pontos e classificação.</span><span><strong>Experience:</strong> jornada validada para MTB e E-bike, sem ranking competitivo.</span></div><a className="engineLink" href="/race-engine">Conheça o Race Engine <span>→</span></a></div></div></section>
      ...
      <section className="daySection" id="experiencia"><div className="wide"><div className="sectionHead"><div><p className="kicker">Um dia na Legends</p><h2>Pedalar. Recuperar.<br /><em>Descobrir. Recomeçar.</em></h2></div><p>Cada dia tem seu próprio ritmo, mas todos terminam preparando o corpo, a bicicleta e a estratégia para um novo capítulo.</p></div><div className="timeline">{timeline.map(([icon,time,text]) => <div className="timelineItem" key={time+text}><span className="timelineIcon" aria-hidden="true">{icon}</span><strong>{time}</strong><span>{text}</span></div>)}</div></div></section>
      ...
      <section className="includedSection"><div className="wide"><div className="sectionHead"><div><p className="kicker">O que está incluído</p><h2>Você cuida da jornada.<br /><em>Nós cuidamos da estrutura.</em></h2></div><p>O pacote foi desenhado para que o participante concentre energia no percurso, na recuperação e na experiência.</p></div><div className="includedGrid">{included.map(item => <div className="includedItem" key={item}>{item}</div>)}</div><div className="kitEditorial"><div className="kitEditorialHead"><p className="kicker">Kit oficial em detalhes</p><h3>Da largada à viagem.</h3><p>Uma identidade criada para acompanhar o participante antes, durante e depois da travessia.</p></div><div className="kitDetailGrid">
        <figure className="kitDetailCard"><div className="kitDetailMedia"><img className="kitDetailProduct" src="/images/kit/jersey-ciclismo.webp" alt="Jersey de ciclismo oficial Legends Bike Race" loading="lazy" /></div><figcaption><strong>Performance</strong><span>Jersey de ciclismo</span></figcaption></figure>
        <figure className="kitDetailCard"><div className="kitDetailMedia"><img className="kitDetailProduct" src="/images/kit/camiseta-casual.webp" alt="Camiseta casual oficial Legends Bike Race" loading="lazy" /></div><figcaption><strong>Identidade</strong><span>Camiseta casual</span></figcaption></figure>
        <figure className="kitDetailCard"><div className="kitDetailMedia"><img className="kitDetailProduct" src="/images/kit/bag-50-litros.webp" alt="Bag oficial de 50 litros Legends Bike Race" loading="lazy" /></div><figcaption><strong>Jornada</strong><span>Bag de 50 litros</span></figcaption></figure>
        <figure className="kitDetailCard"><div className="kitDetailMedia"><img className="kitDetailProduct" src="/images/kit/cap-ciclismo.webp" alt="Cap de ciclismo oficial Legends Bike Race" loading="lazy" /></div><figcaption><strong>Assinatura</strong><span>Cap de ciclismo</span></figcaption></figure>
        <figure className="kitDetailCard"><div className="kitDetailMedia"><img className="kitDetailProduct" src="/images/kit/par-de-meias.webp" alt="Par de meias oficial Legends Bike Race" loading="lazy" /></div><figcaption><strong>Conforto</strong><span>Par de meias</span></figcaption></figure>
        <figure className="kitDetailCard"><div className="kitDetailMedia"><img className="kitDetailProduct" src="/images/kit/placa-gravel.webp" alt="Placa Gravel oficial Legends Bike Race" loading="lazy" /></div><figcaption><strong>Número oficial</strong><span>Placa Gravel</span></figcaption></figure>
      </div></div></div></section>
      ...
      <section className="priorityCta" id="interesse"><div className="wide"><Logo className="ctaLogo" /><p className="kicker">A data ainda será revelada</p><h2>Seja um dos<br /><em>100 Legends.</em></h2><p>Entre para a lista prioritária e receba em primeira mão a data oficial, os valores, os hotéis parceiros e a abertura das inscrições.</p><a className="button" href="/lista-prioritaria">Entrar para a lista prioritária <span>→</span></a></div></section>
