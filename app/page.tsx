  ...
  return (
    <main className="redesign">
      <style>{`
        ...
        .manifestoRedesign{background:var(--paper);color:var(--ink);padding:96px 0}
        .manifestoFeature{position:relative;min-height:760px;overflow:hidden;background:linear-gradient(90deg,rgba(244,240,219,.98) 0%,rgba(244,240,219,.94) 28%,rgba(244,240,219,.68) 45%,rgba(244,240,219,.08) 68%),url('/hero-production.jpg') 62% center/cover no-repeat}
        .manifestoContent{position:relative;z-index:2;width:min(680px,56%);padding:72px 0 58px 48px}
        .manifestoQuote{font:700 clamp(34px,3vw,52px) 'Barlow Condensed';text-transform:uppercase;line-height:.97;max-width:640px;margin:0}.manifestoQuote em{font-style:normal;color:var(--copper)}
        .manifestoRule{width:86px;height:3px;background:var(--copper);margin:30px 0}
        .manifestoCopy{max-width:610px}.manifestoCopy p{font-size:17px;line-height:1.65;color:#242822;margin:0}
        .manifestoButton{display:flex;align-items:center;justify-content:space-between;gap:24px;width:min(100%,580px);margin-top:32px;padding:20px 24px;background:var(--copper);color:#111;font:700 18px 'Barlow Condensed';letter-spacing:.08em;text-transform:uppercase}.manifestoButton span:last-child{font-size:28px}
        .manifestoHighlights{display:grid;grid-template-columns:repeat(4,1fr);width:min(100%,640px);margin-top:30px;border-top:1px solid rgba(17,17,17,.22)}
        .manifestoHighlights span{padding:20px 16px 0 0;border-right:1px solid rgba(17,17,17,.2);font:700 13px 'Barlow Condensed';line-height:1.25;text-transform:uppercase;letter-spacing:.05em}.manifestoHighlights span:last-child{border-right:0;padding-left:16px}
        ...
        @media(max-width:1000px){.redesign .wide{width:min(100% - 48px,920px)}.redesign .sectionHead,.destinationText,.profileBox{grid-template-columns:1fr}.manifestoFeature{min-height:700px;background:linear-gradient(90deg,rgba(244,240,219,.98),rgba(244,240,219,.85) 56%,rgba(244,240,219,.2)),url('/hero-production.jpg') 66% center/cover no-repeat}.manifestoContent{width:68%;padding-left:36px}.factsGrid,.safetyGrid,.stageGridNew{grid-template-columns:1fr 1fr}.modeGrid{grid-template-columns:1fr}.includedGrid{grid-template-columns:1fr 1fr}}
        @media(max-width:640px){.redesign .wide{width:calc(100% - 32px)}.heroRedesign{grid-template-rows:82px 1fr auto;min-height:100svh;background-position:68% center}.heroMain{padding:44px 0}.heroCopy h1{font-size:56px}.heroIntro{font-size:16px}.heroStats{grid-template-columns:1fr 1fr}.heroStat:nth-child(2){border-right:0}.heroStat:nth-child(-n+2){border-bottom:1px solid var(--line)}.heroStat strong{font-size:38px}.manifestoRedesign,.factsBand,.modes,.daySection,.routePreview,.destinationStory,.includedSection,.safetySection,.profileSection,.faqSection{padding:78px 0}.manifestoFeature{min-height:760px;background:linear-gradient(180deg,rgba(244,240,219,.98) 0%,rgba(244,240,219,.94) 48%,rgba(244,240,219,.18) 74%),url('/hero-production.jpg') 67% center/cover no-repeat}.manifestoContent{width:100%;padding:42px 22px}.manifestoQuote{font-size:34px;max-width:100%}.manifestoCopy p{font-size:16px}.manifestoButton{font-size:16px;padding:18px}.manifestoHighlights{grid-template-columns:1fr 1fr}.manifestoHighlights span{border-bottom:1px solid rgba(17,17,17,.2);padding:18px 10px 18px 0}.factsGrid,.stageGridNew,.safetyGrid,.includedGrid,.cityStrip{grid-template-columns:1fr}.fact,.stageNew,.safetyCard,.cityStrip a{border-right:0;border-bottom:1px solid var(--line)}.modeCard{padding:34px 26px}.timelineItem{grid-template-columns:90px 1fr;gap:18px}.stageNew{min-height:330px}.destinationText{gap:20px}.cityStrip a:last-child{padding-left:0}.includedGrid{background:transparent;border:0}.includedItem{border-bottom:1px solid var(--line)}.profileBox{gap:34px}}
      `}</style>
