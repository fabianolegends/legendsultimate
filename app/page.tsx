  ...
  return (
    <main className="redesign">
      <style>{`
        ...
        .manifestoRedesign{background:var(--paper);color:var(--ink);padding:120px 0}.manifestoFeature{display:grid;grid-template-columns:minmax(0,1.05fr) minmax(420px,.95fr);min-height:720px;overflow:hidden;background:#eee7d8}
        .manifestoContent{padding:72px 66px 62px}.manifestoQuote{font:700 clamp(38px,3.65vw,62px) 'Barlow Condensed';text-transform:uppercase;line-height:.94;max-width:820px;margin:0}.manifestoQuote em{font-style:normal;color:var(--copper)}
        .manifestoRule{width:110px;height:3px;background:var(--copper);margin:30px 0}.manifestoCopy{display:grid;gap:14px;max-width:720px}.manifestoCopy p{font-size:17px;line-height:1.68;color:#424640;margin:0}
        .manifestoButton{display:flex;align-items:center;justify-content:space-between;gap:24px;width:min(100%,620px);margin-top:34px;padding:21px 24px;background:var(--copper);color:#111;font:700 18px 'Barlow Condensed';letter-spacing:.08em;text-transform:uppercase}.manifestoButton span:last-child{font-size:28px}
        .manifestoHighlights{display:grid;grid-template-columns:repeat(4,1fr);margin-top:34px;border-top:1px solid #c9bfb0}.manifestoHighlights span{padding:22px 18px 0 0;border-right:1px solid #c9bfb0;font:700 13px 'Barlow Condensed';line-height:1.25;text-transform:uppercase;letter-spacing:.05em}.manifestoHighlights span:last-child{border-right:0;padding-left:18px}
        .manifestoVisual{min-height:720px;background:linear-gradient(90deg,#eee7d8 0%,rgba(238,231,216,.1) 28%),url('/hero-production.jpg') 63% center/cover no-repeat}
        ...
        @media(max-width:1000px){.redesign .wide{width:min(100% - 48px,920px)}.redesign .sectionHead,.destinationText,.profileBox{grid-template-columns:1fr}.manifestoFeature{grid-template-columns:1fr}.manifestoVisual{min-height:520px;background-position:center}.factsGrid,.safetyGrid,.stageGridNew{grid-template-columns:1fr 1fr}.modeGrid{grid-template-columns:1fr}.includedGrid{grid-template-columns:1fr 1fr}}
        @media(max-width:640px){.redesign .wide{width:calc(100% - 32px)}.heroRedesign{grid-template-rows:82px 1fr auto;min-height:100svh;background-position:68% center}.heroMain{padding:44px 0}.heroCopy h1{font-size:56px}.heroIntro{font-size:16px}.heroStats{grid-template-columns:1fr 1fr}.heroStat:nth-child(2){border-right:0}.heroStat:nth-child(-n+2){border-bottom:1px solid var(--line)}.heroStat strong{font-size:38px}.manifestoRedesign,.factsBand,.modes,.daySection,.routePreview,.destinationStory,.includedSection,.safetySection,.profileSection,.faqSection{padding:90px 0}.manifestoContent{padding:42px 24px}.manifestoQuote{font-size:38px}.manifestoHighlights{grid-template-columns:1fr 1fr}.manifestoHighlights span{border-bottom:1px solid #c9bfb0;padding:18px 12px 18px 0}.manifestoVisual{min-height:420px}.manifestoGrid,.factsGrid,.stageGridNew,.safetyGrid,.includedGrid,.cityStrip{grid-template-columns:1fr}.fact,.stageNew,.safetyCard,.cityStrip a{border-right:0;border-bottom:1px solid var(--line)}.modeCard{padding:34px 26px}.timelineItem{grid-template-columns:90px 1fr;gap:18px}.stageNew{min-height:330px}.destinationText{gap:20px}.cityStrip a:last-child{padding-left:0}.includedGrid{background:transparent;border:0}.includedItem{border-bottom:1px solid var(--line)}.profileBox{gap:34px}}
      `}</style>
      ...
      <section className="manifestoRedesign" id="conceito"><div className="wide manifestoFeature">
        ...
        <div className="manifestoVisual" role="img" aria-label="Ciclista de gravel percorrendo as estradas da Serra Gaúcha" />
      </div></section>
