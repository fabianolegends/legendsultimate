...
export default function Home() {
  return (
    <main className="redesign">
      ...
      <section className="includedSection"><div className="wide"><div className="sectionHead"><div><p className="kicker">O que está incluído</p><h2>Você cuida da jornada.<br /><em>Nós cuidamos da estrutura.</em></h2></div><p>O pacote foi desenhado para que o participante concentre energia no percurso, na recuperação e na experiência.</p></div><div className="includedGrid">{included.map(item => <div className="includedItem" key={item}>{item}</div>)}</div><div className="kitEditorial"><div className="kitEditorialHead"><p className="kicker">Kit oficial em detalhes</p><h3>Da largada à viagem.</h3><p>Uma identidade criada para acompanhar o participante antes, durante e depois da travessia.</p></div><div className="kitDetailGrid"><figure className="kitDetailCard kitDetailRace"><div className="kitDetailImage" role="img" aria-label="Jersey oficial Legends Ultimate"></div><figcaption><strong>Performance</strong><span>Jersey e acessórios de ciclismo</span></figcaption></figure><figure className="kitDetailCard kitDetailCasual"><div className="kitDetailImage" role="img" aria-label="Camiseta oficial Legends Ultimate"></div><figcaption><strong>Identidade</strong><span>Camiseta e cap oficiais</span></figcaption></figure><figure className="kitDetailCard kitDetailTravel"><div className="kitDetailImage" role="img" aria-label="Bag oficial Legends Ultimate"></div><figcaption><strong>Jornada</strong><span>Bag de 50 litros para a travessia</span></figcaption></figure></div></div></div></section>
