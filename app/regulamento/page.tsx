...
export const metadata: Metadata = {
  title: "Regulamento da Legends Bike Race 2027",
  description: "Consulte o regulamento oficial da Legends Bike Race 2027, prova de gravel em etapas realizada de 29 de abril a 2 de maio na Serra Gaúcha.",
  alternates: { canonical: "/regulamento" },
};

const sections = [
  ["1", "Do evento", [
    "A Legends Bike Race é um evento ciclístico de longa distância em formato Stage Race, com características de travessia, autonavegação e deslocamento entre diferentes cidades-base.",
    "A Legends Ultimate será realizada de 29 de abril a 2 de maio de 2027, com quatro etapas, aproximadamente 370,3 km, 6.302 m+ acumulados e limite de 100 participantes.",
    "A Legends Short será realizada em 1º e 2 de maio de 2027, nas Stages 03 e 04, com aproximadamente 169,3 km, 3.098 m+ acumulados e limite de 50 participantes.",
    "Distâncias, altimetrias, traçado, largadas, chegadas, checkpoints e horários poderão sofrer ajustes técnicos por segurança, condição das vias, autorização pública, meteorologia ou razões operacionais."
  ]],
  ["2", "Formatos e modalidades", [
    "Formato da jornada: Legends Ultimate, com as Stages 01 a 04; ou Legends Short, com as Stages 03 e 04. Cada formato possui inscrição, limite de vagas, classificação e premiação próprios.",
  ...
  ["3", "Elegibilidade e documentação", [
    "Poderão participar pessoas com 18 anos ou mais no ano-base da competição. O participante declara possuir condição física, técnica e psicológica compatível com a jornada escolhida — dois dias na Short ou quatro dias na Ultimate —, incluindo longa distância, altimetria elevada, estradas não pavimentadas, trânsito compartilhado e autonavegação.",
  ...
  ["18", "Classificação por pontos e premiação", ["Ultimate e Short terão classificações independentes em cada categoria da Gravel Race. A Ultimate soma os pontos válidos das Stages 01 a 04; a Short soma os pontos válidos das Stages 03 e 04.", "Coeficientes: Stage 01 1,15; Stage 02 1,00; Stage 03 1,20; Stage 04 0,65. Referência: Pontos = 100 × (melhor tempo válido da categoria ÷ tempo válido do atleta) × coeficiente da etapa.", "A Ultimate premiará com troféus do 1º ao 5º colocado de cada categoria. A Short premiará com troféus do 1º ao 3º colocado de cada categoria."]],
  ...
  ["30", "Troca de formato ou modalidade", ["A troca entre Ultimate e Short ou entre Gravel Race e Legends Experience poderá ser solicitada até 15 dias antes, mediante disponibilidade, requisitos, aprovação e eventual diferença financeira. Não há transferência de pontos ou resultados entre formatos ou modalidades."]],
