...
const sections = [
  ...
  ["18", "Classificação por pontos", ["A classificação geral da Gravel Race será baseada na soma dos pontos válidos. Coeficientes: Stage 01 1,15; Stage 02 1,00; Stage 03 1,20; Stage 04 0,65.", "Referência: Pontos = 100 × (melhor tempo válido da categoria ÷ tempo válido do atleta) × coeficiente da etapa."]],
