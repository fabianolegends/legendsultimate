...
export default function FAQ() {
  return <main className="faqPage"><style>{`
    ...
    .kicker{color:var(--copper);font:600 14px 'Barlow Condensed';text-transform:uppercase;letter-spacing:.22em}h1,h2{color:#f4f0db;font-family:'Barlow Condensed';text-transform:uppercase;line-height:.9;margin:20px 0}h1{font-size:clamp(54px,7vw,88px)}h2{font-size:clamp(38px,5vw,62px)}
