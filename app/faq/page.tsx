...
export default function FAQ() {
  return <main className="faqPage"><style>{`
    .faqPage{--paper:#f4f0db;--ink:#0b0d0c;--copper:#c67a3b;--line:rgba(198,122,59,.34);background:var(--paper);color:var(--ink);min-height:100vh}.wrap{width:min(1120px,calc(100% - 80px));margin:auto}
    ...
    .kicker{color:var(--copper);font:600 14px 'Barlow Condensed';text-transform:uppercase;letter-spacing:.22em}h1,h2{color:var(--ink);font-family:'Barlow Condensed';text-transform:uppercase;line-height:.9;margin:20px 0}h1{font-size:clamp(54px,7vw,88px)}h2{font-size:clamp(38px,5vw,62px)}
    .questions{scroll-margin-top:0;padding-top:56px}.questionsHead{padding-bottom:38px}.questionsHead h1{margin-bottom:0}.group{padding:48px 0;border-top:1px solid var(--line)}details{border-bottom:1px solid rgba(198,122,59,.22);padding:22px 0}summary{cursor:pointer;list-style:none;color:var(--ink);font:600 24px 'Barlow Condensed';text-transform:uppercase}summary:after{content:'+';float:right;color:var(--copper)}details[open] summary:after{content:'–'}details p{max-width:900px;color:#5f625d;line-height:1.75}
