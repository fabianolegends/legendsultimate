...
const menuItems = [
  ...
  {
    number: "04",
    title: "Categorias e premiação",
    summary: "Categorias por faixa etária e troféus até o quinto colocado após a conclusão das quatro etapas.",
    detail: [
      ...
      "§ Premiação",
      "• Troféus do 1º ao 5º colocado de cada categoria",
      "• Cerimônia de premiação após a conclusão da Stage 04",
      "Não haverá premiação diária. Os resultados de cada etapa serão utilizados para distribuir os pontos e formar a classificação geral da competição. A premiação será realizada somente ao final das quatro etapas, considerando a colocação definitiva de cada atleta em sua categoria.",
    ...
    link: "Veja categorias e premiação",
  },
  {
    number: "05",
