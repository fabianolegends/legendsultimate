...
export default function OrganizationDashboard() {
  ...
  `}</style><div className={`ops-wrap ${loading ? "ops-loading" : ""}`}>
    ...
    <section className="ops-shortcuts"><a className="ops-shortcut" href="/passport/organizacao/inscritos"><strong>Inscritos</strong><span>{registrationSummary?.total ?? 0} registros · {registrationSummary?.linked ?? 0} vinculados ao Ride with GPS</span></a><a className="ops-shortcut health" href="/passport/organizacao/saude"><strong>Declarações de saúde</strong><span>Dados sensíveis enviados online pelos atletas, contato de emergência e alertas clínicos declarados.</span></a><a className="ops-shortcut" href="/passport/organizacao/rotas"><strong>Percursos e checkpoints</strong><span>Gerencie GPX, versões oficiais e pontos de controle.</span></a><a className="ops-shortcut" href="/passport/organizacao/impressao"><strong>Documentos oficiais</strong><span>Gere resultados por categoria, geral e relatórios com checkpoints.</span></a></section>
  </div></main>;
}
