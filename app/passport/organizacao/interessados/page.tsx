  ...
  return (
    <main className="leadPage">
      <style>{`
        ...
        .leadToolbar{display:flex;gap:14px;margin-bottom:20px}.leadSearch{flex:1;background:#111511;border:1px solid #454b43;color:#eee9df;padding:16px 18px;font:inherit}.leadRefresh{background:#d8660a;border:0;color:#fff;padding:0 24px;font:700 13px 'Barlow Condensed';text-transform:uppercase;letter-spacing:.08em;cursor:pointer}
        ...
        @media(max-width:800px){.leadPage{padding:38px 20px 70px}.leadStats{grid-template-columns:1fr}.leadStat{border-right:0;border-bottom:1px solid #343932}.leadToolbar{flex-direction:column}.leadRefresh{padding:16px}}
      `}</style>
      ...
      <div className="leadToolbar">
        ...
        />
        <button className="leadRefresh" type="button" onClick={() => void loadLeads()}>
          Atualizar lista
        </button>
      </div>
