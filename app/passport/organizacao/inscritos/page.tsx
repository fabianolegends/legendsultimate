                      ...
                      return (
                        <tr key={item.id}>
                          ...
                          <td>
                            ...
                            {item.external_registration_id ? (
                              <span>
                                ID externo: {item.external_registration_id}
                              </span>
                            ) : null}
                          </td>
                          <td>
                          ...
                          <td className="code">
                            <button
                              ...
                              onClick={() => copyCode(item.registration_code)}
                            >
                              {item.registration_code}
                              <small>
                          ...
                          <td>
                            ...
                            >
                              {item.athlete_id
                                ? `✓ Ride with GPS ${item.athlete?.ride_with_gps_user_id ?? ""}`
                                : "Aguardando vínculo"}
                            </span>
                          </td>
                          <td>
