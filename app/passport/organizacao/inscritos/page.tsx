...
export default function RegistrationsPage() {
  ...
  const [moduleReady, setModuleReady] = useState(true); const [windfitReady, setWindfitReady] = useState(true); const [detailsReady,setDetailsReady]=useState(true); const [numberingReady,setNumberingReady]=useState(true);
