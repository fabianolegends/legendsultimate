...
export default function StewardingPage() {
  ...
  async function load() {
    ...
    const response = await fetch(
      `/api/admin/stewarding?eventId=${encodeURIComponent(activeEventId)}`,
      { cache: "no-store" },
    );
      ...
      <div className="shell">
        <section className="head">
          ...
          <p>
            ...
            <br />
            Revise duplicidades, aplique decisões esportivas e publique somente
