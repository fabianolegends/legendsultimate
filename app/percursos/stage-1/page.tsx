...
export default function StageOne() {
  return (
    <main className="stagePage">
      ...
      <section className="stageDetailHero shell">
      ...
      <section className="stageProfile shell">
        ...
        <img src="/perfil-stage-1.jpg" alt="Perfil de elevação e distribuição de superfícies da Stage 1" className="profileImage" />
      </section>
