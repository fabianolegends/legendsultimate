  ...
  return (
    <main className="registrationPage">
      <style>{`
        ...
        .launchCard{border:1px solid var(--line);background:rgba(12,15,13,.84);backdrop-filter:blur(10px);padding:28px}.launchCard strong{display:flex;align-items:baseline;gap:.18em;font:700 43px 'Barlow Condensed';text-transform:uppercase}.launchCard strong .journeyScript{font-size:.68em;color:var(--copper)}.launchCard small{display:block;color:#c0bdb6;margin-top:4px}.mainCta{display:flex;justify-content:space-between;align-items:center;margin-top:22px;background:var(--copper);color:white;padding:17px 20px;font:700 15px 'Barlow Condensed';letter-spacing:.09em;text-transform:uppercase}.mainCta[aria-disabled="true"]{opacity:.72;pointer-events:none}
      ...
      <section className="regHero">
        <div className="shell heroGrid">
          ...
          <aside className="launchCard">
            ...
            <strong><span>Legends</span><em className="journeyScript">{format === "short" ? "Short" : "Ultimate"}</em></strong>
