          ...
          <div className="regAccordions">
            ...
            <details name="registration-details" className="regAccordion">
              <summary>
                ...
                <span className="accordionTitle"><strong>Premiação</strong><small>Troféus do 1º ao 5º lugar de cada categoria</small></span>
                <span className="accordionToggle" aria-hidden="true"><AccordionToggleIcons /></span>
              </summary>
              <div className="accordionBody">
                <div className="awardsPanel">
                  <div>
                    ...
                    <h3>Os pontos das quatro etapas definem o pódio</h3>
                    <p>Ao final da jornada, recebem troféus os atletas classificados do 1º ao 5º lugar de cada categoria da Gravel Race. A classificação geral será definida pelo somatório dos pontos obtidos nas quatro etapas.</p>
                  ...
                  <div className="awardPlaces" aria-label="Colocações premiadas com troféu">
                    {["1º", "2º", "3º", "4º", "5º"].map(place=><div className="awardPlace" key={place}><strong>{place}</strong><span>Troféu</span></div>)}
                  </div>
                </div>
              </div>
            </details>
