  ...
  return (
    <main className="registrationPage">
      <style>{`
        ...
        .premiumOptions{display:grid;grid-template-columns:1.35fr .65fr;gap:18px}.premiumOption{position:relative;border:1px solid rgba(17,17,17,.17);padding:28px 34px 34px;display:grid;grid-template-rows:minmax(220px,1fr) auto;gap:24px;background:rgba(255,255,255,.17);overflow:hidden}.premiumOption.featured{border-color:rgba(185,111,72,.72);background:linear-gradient(135deg,rgba(185,111,72,.09),rgba(255,255,255,.12))}.premiumBadge{position:absolute;z-index:2;top:0;left:34px;transform:translateY(-50%);background:var(--copper);color:#fff;padding:7px 11px;font:700 10px 'Barlow Condensed';letter-spacing:.15em;text-transform:uppercase}.premiumVisual{display:grid;place-items:center;min-height:0}.premiumVisual img{display:block;width:100%;height:100%;max-height:285px;object-fit:contain;filter:drop-shadow(0 18px 22px rgba(30,22,16,.18))}.premiumOption:not(.featured) .premiumVisual img{max-height:270px}.premiumContent{display:grid;grid-template-columns:minmax(0,1fr) auto;gap:28px;align-items:end}.premiumOption h3{font:700 36px 'Barlow Condensed';text-transform:uppercase;margin:0 0 12px}.premiumOption p{color:#676a65;line-height:1.6;margin:0}.premiumItems{display:flex;gap:8px;flex-wrap:wrap;margin-top:18px}.premiumItems span{border:1px solid rgba(17,17,17,.15);padding:8px 10px;font:600 11px 'Barlow Condensed';text-transform:uppercase;letter-spacing:.05em}.price{color:var(--copper);font:700 48px 'Barlow Condensed';white-space:nowrap}.price small{display:block;font:600 10px 'Barlow Condensed';letter-spacing:.12em;text-transform:uppercase;color:#777;margin-bottom:4px}
