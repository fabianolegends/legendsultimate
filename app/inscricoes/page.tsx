  ...
  return (
    <main className="registrationPage">
      <style>{`
        ...
        @media(max-width:850px){.heroGrid,.columns,.modeGrid,.premiumOptions{grid-template-columns:1fr}.lotGrid{grid-template-columns:1fr}.lot{border-right:0;border-bottom:1px solid var(--line)}.lot:last-child{border-bottom:0}.activeLotBadge{top:14px;right:14px}.docs{grid-template-columns:1fr}.premiumOption{grid-template-columns:1fr}.premiumBadge{left:24px}.regHero{padding-top:60px}.registrationPage .shell{width:min(100% - 30px,1180px)}}
      `}</style>
