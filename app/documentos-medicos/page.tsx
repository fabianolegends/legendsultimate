  ...
  return (
    <main className="medicalPage">
      <style>{`
        ...
        .medicalPage .hero h1{font:700 clamp(36.4px,4.34vw,61.6px) 'Barlow Condensed';line-height:.88;text-transform:uppercase;margin:14px 0;max-width:680px}
        ...
        @media(max-width:760px){.medicalPage .shell,.medicalPage .heroInner{width:calc(100% - 30px)}.medicalPage .hero{height:350px!important;min-height:350px!important;background-position:58% center!important}.medicalPage .hero h1{font-size:37.8px}.medicalPage .hero p{font-size:15px}.medicalPage .cards,.medicalPage .rulesGrid{grid-template-columns:1fr}.medicalPage .card{min-height:260px}.medicalPage .top img{height:54px}}
      `}</style>
